...
public class ExemploDois {
    public static void main(String[] args) {
        // Exemplos - Utilizando boolean para imprimir a mensagem de FALSE ou TRUE para
        // comparação
        int i1 = 10;
        int i2 = 20;
        float f1 = 4.5f;
        ...
        System.out.println("c1 != c2 " + (c1 != c2));
        System.out.println("c1 > c2 " + (c1 > c2));
        System.out.println("c1 <= c2 " + (c1 <= c2)); // Conseguimos comparar o CHAR porque ele é um TAMANHO
        // que representa uma letra, então podemos definir se ele é > MAIOR ou < MENOR
