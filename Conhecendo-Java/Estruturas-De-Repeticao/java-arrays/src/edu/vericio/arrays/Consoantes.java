...
public class Consoantes {
    public static void main(String[] args) {
        ...
        System.out.println("Quantidade de consoantes: " + quantidadeConsoantes); // Imprime a quantidade de consoantes
        System.out.println(consoantes.length); // Imprime o número de consoantes
